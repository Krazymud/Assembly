...
HD_PWD='/home/eadric/Desktop/singleCpu/singleCpu.runs/cpu_led_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_led_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_led_0_0.tcl
