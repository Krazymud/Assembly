...
HD_PWD='/home/eadric/Desktop/singleCpu/singleCpu.runs/cpu_ctrlUnit_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cpu_ctrlUnit_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cpu_ctrlUnit_0_0.tcl
